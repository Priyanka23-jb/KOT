...
export default function OrganisationType() {
  ...
  const [organisationTypes, setOrganisationTypes] = useState([
    { id: 1, name: "Private Limited", status: "Active" },
    { id: 2, name: "Public Limited", status: "Active" },
    { id: 3, name: "Government", status: "Inactive" },
    { id: 4, name: "Non-Profit", status: "Pending" },
    { id: 5, name: "Partnership", status: "Active" },
  ]);

  /* ---------- Helpers ---------- */

  const filteredData = organisationTypes.filter((item) =>
        ...
        <div className="col-span-12 lg:col-span-4 bg-white dark:bg-gray-800 rounded-xl shadow-md p-5">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                value={organisationTypeName}
                onChange={(e) => setOrganisationTypeName(e.target.value)}
            ...
            <table className="w-full text-sm">
              <thead className="bg-purple-50 dark:bg-purple-900/20">
                <tr>
                  ...
                  <th className="p-3 text-left">Organisation Type Name</th>
