...
import {
  ...
  ChevronRight, ChevronLeft, Plus, Trash2, Save, ArrowLeft, Home, Check,
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {['AMC Services', 'Installation', 'Maintenance', 'Repair', 'Audit', 'Consulting', 'Training', 'Spare Parts'].map((service) => (
                    <label key={service} className="flex items-center gap-3 p-3 border border-gray-300 dark:border-gray-600 rounded hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer">
                      <input
                        type="checkbox"
                        name="services[]"
                        value={service}
                        ...
                        className="w-4 h-4 text-purple-600 rounded"
                      />
                      <span className="text-gray-800 dark:text-gray-300">{service}</span>
                    </label>
                  ))}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-2 rounded border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-white"
                    onKeyPress={(e) => {
                      if (e.key === 'Enter') {
                        e.preventDefault();
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded p-4 hover:border-purple-500 transition-colors">
                    ...
                    <label htmlFor="reg-cert-upload" className="cursor-pointer flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-gray-600 dark:text-gray-400">Click to upload registration certificate</p>
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded p-4 hover:border-purple-500 transition-colors">
                    ...
                    <label htmlFor="gst-cert-upload" className="cursor-pointer flex items-center gap-3">
                      <Upload className="w-8 h-8 text-gray-400" />
                      <div>
                        <p className="text-gray-600 dark:text-gray-400">Click to upload GST certificate</p>
                        <p className="text-xs text-gray-500">PDF, PNG, JPG up to 5MB</p>
                      </div>
                    </label>
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded p-4 hover:border-purple-500 transition-colors">
                    ...
                    <label htmlFor="bank-proof-upload" className="cursor-pointer flex items-center gap-3">
                      <Upload className="w-8 h-8 text-gray-400" />
                      <div>
                        <p className="text-gray-600 dark:text-gray-400">Click to upload bank proof</p>
                        <p className="text-xs text-gray-500">PDF, PNG, JPG up to 5MB</p>
                      </div>
                    </label>
                    {formData.bankProof && (
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                <label className="flex items-start gap-3">
                  ...
                  />
                  <div>
                    <span className="font-medium text-gray-800 dark:text-gray-300">GST Declaration</span>
                ...
                <label className="flex items-start gap-3">
                  ...
                  />
                  <div>
                    <span className="font-medium text-gray-800 dark:text-gray-300">Quality Assurance Declaration</span>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                ...
                <label className="flex items-start gap-3">
                  ...
                  />
                  <div>
                    <span className="font-medium text-gray-800 dark:text-gray-300">Confidentiality Declaration</span>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
              ...
              <div className="bg-purple-50 dark:bg-purple-900/30 border border-purple-200 dark:border-purple-800 rounded p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-purple-800 dark:text-purple-300 mb-1">Legal Notice</h4>
          ...
          {step === 11 && (
            <div className="space-y-6">
              <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded p-6">
                <h3 className="font-semibold text-gray-800 dark:text-white mb-4">Review Your Information</h3>

                <div className="space-y-4">
                  <div>
                    <h4 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Basic Information</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                      <div><span className="text-gray-600 dark:text-gray-400">Vendor Type:</span> {formData.vendorType}</div>
                      <div><span className="text-gray-600 dark:text-gray-400">Legal Name:</span> {formData.vendorLegalName}</div>
                      <div><span className="text-gray-600 dark:text-gray-400">Year Established:</span> {formData.yearOfEstablishment}</div>
                      <div><span className="text-gray-600 dark:text-gray-400">GST Registered:</span> {formData.gstRegistered}</div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                      <div><span className="text-gray-600 dark:text-gray-400">Primary Contact:</span> {formData.primaryContact}</div>
                      <div><span className="text-gray-600 dark:text-gray-400">Email:</span> {formData.email}</div>
                      <div><span className="text-gray-600 dark:text-gray-400">Address:</span> {formData.address}</div>
                    </div>
                  </div>
                  ...
                  <div>
                    <h4 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Banking Details</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                      <div><span className="text-gray-600 dark:text-gray-400">Bank:</span> {formData.bankName}</div>
                      <div><span className="text-gray-600 dark:text-gray-400">Account Number:</span> {formData.accountNumber}</div>
                      <div><span className="text-gray-600 dark:text-gray-400">IFSC Code:</span> {formData.ifscCode}</div>
                      <div><span className="text-gray-600 dark:text-gray-400">PAN:</span> {formData.panNumber}</div>
                    </div>
                  </div>

                  <div>
                    <h4 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Documents Uploaded</h4>
                    <div className="space-y-2 text-sm">
                      <div className="flex items-center gap-2">
                        {formData.registrationCertificate && (
                          <CheckCircle className="w-4 h-4 text-green-500" />
                        )}
                        <span className="text-gray-600 dark:text-gray-400">Registration Certificate: {formData.registrationCertificate ? 'Uploaded' : 'Missing'}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        {formData.gstCertificate && (
                          <CheckCircle className="w-4 h-4 text-green-500" />
                        )}
                        <span className="text-gray-600 dark:text-gray-400">GST Certificate: {formData.gstCertificate ? 'Uploaded' : 'Missing'}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        {formData.bankProof && (
                          <CheckCircle className="w-4 h-4 text-green-500" />
                        )}
                        <span className="text-gray-600 dark:text-gray-400">Bank Proof: {formData.bankProof ? 'Uploaded' : 'Missing'}</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-800 rounded p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-yellow-800 dark:text-yellow-300 mb-1">Final Review</h4>
